    ...
    <div>
        ...
        <div class="ml-10 mt-10 mr-10">
            ...
            <div class="video-area" id="video-area">
                ...
                <section style="width:1200px !important" x-data="{isCollapsed: false,}" class="fi-section rounded-2xl bg-white shadow-sm ring-1 ring-gray-950/5 dark:bg-gray-900 dark:ring-white/10" id="data.customer-details">
                    <header class="fi-section-header flex items-center justify-between gap-x-3 overflow-hidden px-6 py-4">
